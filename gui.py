...
class FacebookSchedulerApp:
    ...
    Attributes:
        ...
        media_path (Optional[str]): Path to the selected media file.
        media_type (ctk.StringVar): Type of the media (text, image, video).
    """
    ...
    def __init__(self, root: ctk.CTk) -> None:
        ...
        self.media_path: Optional[str] = None  # Will store selected file path
        self.media_type: ctk.StringVar = ctk.StringVar(value="text")
    ...
    def build_interface(self) -> None:
        ...
        ctk.CTkRadioButton(self.media_frame, text="Text", variable=self.media_type, value="text").pack(side="left", padx=5)
        ctk.CTkRadioButton(self.media_frame, text="Image", variable=self.media_type, value="image").pack(side="left", padx=5)
        ctk.CTkRadioButton(self.media_frame, text="Video", variable=self.media_type, value="video").pack(side="left", padx=5)
        ...
        self.time_entry = ctk.CTkEntry(self.root, placeholder_text="Schedule Time (HH:MM)")
        ...
        # Theme toggle switch
        self.theme_switch = ctk.CTkSwitch(self.root, text="Light/Dark Mode", command=self.toggle_theme)
    ...
    def browse_file(self) -> None:
        ...
        if file_path:
            ...
            self.file_label.configure(text=f"Selected: {file_path.split('/')[-1]}")

    def submit(self) -> None:
        """
        Validates inputs and schedules the Facebook post using the external service.
        ...
        # Show confirmation
        messagebox.showinfo("Success", f"Your {media_type} post has been scheduled!")
